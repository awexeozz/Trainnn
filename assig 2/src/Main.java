...
public class Main {
    public static void main(String[] args) {
        ...
        Train Speed = new Train();
        Speed.setMaxVagon(10);
        Speed.setName("Speed");
        Speed.setPassengers(new ArrayList<>());
        ...
        Speed.setVagons(temp);
        {
            ArrayList<Passenger> passengers = new ArrayList<>();
            passengers.add(new Elderly("Name","Surname",90,"123123123123","N",1,Speed,3));
            passengers.add(new Student("Alinur","Alinurov",18,"123456789123","N",1,Speed,1));
            passengers.add(new Student("Yerbulan","Yerbulanov",19,"010203040506","Y",1,Speed,7));
            passengers.add((new Child("Arshyn","Arshynov",7,"777777777777","N",3,Speed,10)));

            Speed.setPassengers(passengers);
        }

        Train Rocket = new Train();
        Rocket.setPassengers(new  ArrayList<>());
        ...
        Rocket.setVagons(temp1);
        Rocket.setMaxVagon(3);
    ...
    private static void addPassenger(ArrayList<Train> Trains){
        ...
        Train train = (trainName.equalsIgnoreCase("Rocket")?Trains.get(1):Trains.get(0));
